...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mt-5">
            <div class="card">
            <div class="card-header text-white" style="background-color:rgba(0, 0, 0, 0.684);">{{"Edit Fild Officer"}}</div>
                <div class="card-body">
                    @if (session('status'))
                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$fo->email}}</td>
                                        <td>{{$fo->mobile}}</td>
                                        <td><a href="javascript:void(0);" onclick="editfo('{{ $fo->id}}')" class="p-1" data-bs-toggle="modal" data-bs-target="#exampleModalToggle">Edit</a>
                                        <a href="{{url('deactivefo').'/'.encrypt($fo->id)}}"  class="p-1">Deactivate</a>
                                    </tr>
                                    @endforeach
                                </tbody>
                        </table>
        ...
        <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-header text-white" style="background-color:rgba(0, 0, 0, 0.684);">
                        <h5 class="modal-title" id="exampleModalToggleLabel">Edit Fo</h5>
                    ...
                    <div class="modal-body">
                        <form action='' method='POST' id="form_id">
                            ...
                            <input type="hidden" name="_method" value="PUT">
                                ...
                                <tr>
                                    <td> Mobile</td>
                                    <td><input id="mobile" type="text" name="mobile" class="form-control" required /></td>
                                </tr>
                                <tr>
