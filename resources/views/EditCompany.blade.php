                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$company->shot_name}}</td>
                                    <td><a href="javascript:void(0);" onclick="editcompany('{{ $company->id}}')" class="p-1" data-bs-toggle="modal" data-bs-target="#exampleModalToggle">Edit</a>
                                </tr>
                                @endforeach
                            </tbody>
                    </table>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header text-white" style="background-color:rgba(0, 0, 0, 0.684);">
                        <h5 class="modal-title" id="exampleModalToggleLabel">Edit Company</h5>
                    ...
                    <div class="modal-body">
                        <form action='' method='POST' id="form_id">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <td><input type=submit value='Edit Company'  id ="edit" class="btn btn-dark">
                                    </td>
                                </tr>
                            </table>
                        </form>
